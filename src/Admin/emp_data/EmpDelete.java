...
public class EmpDelete extends EmpInput {
  ...
  public static void deleteStaffInfo(int id) {
    ...
    try {
      ...
      String sql5 = "DELETE FROM LeavesBalance WHERE EMPLOYEE_ID = ?";
      String sql6 = "DELETE FROM Leaves WHERE EMPLOYEE_ID = ?";
      String sql7 = "DELETE FROM DayShift WHERE EMPLOYEE_ID = ?";
