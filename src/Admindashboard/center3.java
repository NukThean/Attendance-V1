...
public class center3 extends JPanel implements ActionListener {
  ...
  int StaffShiftToday = asdas.getTodayShiftCount();
  ...
  private JLabel onleave =
      new JLabel("<html><div style='text-align:center;'>Permission <br> Leave</div></html>");
  ...
  public center3() {
    ...
    addDbToPanel(ccent, ddc, null, 0, 0, null, new JLabel(), todayShift, shiftCount);

    addDbToPanel(ccent, aac, bbc, 1, 0, null, emojiPanel.getEmoji5(), onleave, new JLabel("0")); // Placeholder
    // for leave
    // value
